# App Store — Quanto Falta?

## Identidade
- **Nome (pt-BR):** Quanto Falta?
- **Nome (en):** What's Missing?
- **Bundle ID:** com.felipehunas.AlbumTracker
- **Idioma primário:** Português (Brasil) · **Disponibilidade:** somente Brasil (v1)
- **Categoria:** Esportes (primária), Utilidades (secundária) · **Classificação:** 4+
- **Preço:** Grátis · **Privacidade (nutrition label):** "Dados não coletados"

## Subtítulo (máx. 30 caracteres)
- Opção A: `Complete seu álbum` (18)
- Opção B: `Tenho, falta e repetidas` (24)

## Palavras-chave (máx. 100 caracteres — não usar marcas: panini, fifa, world cup)
```
figurinhas,álbum,copa,2026,colecionador,trocas,repetidas,faltantes,cromos,futebol,seleção,completar
```

## Texto promocional (máx. 170)
Seu gerenciador de figurinhas da copa do mundo! Marque o que tem, veja quanto falta e organize suas trocas.
...
## Notas para o App Review
Unofficial companion app for tracking a personal sticker collection. All data is
stored locally on device (SwiftData); no account, no network calls, nothing
collected — see the bundled privacy manifest. References to third-party products
are nominative/factual only.

## Screenshots
`Marketing/screenshots/pt-BR/` — 6 imagens em 1320×2868 (6.9", obrigatório).
